...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    ...
    wallet.on("closeVatom", (data) => {print(data), Navigator.pop(context)});
  }
        ...
        child: Column(
          ...
          children: <Widget>[
            ElevatedButton(
              onPressed: () => {
                wallet.linkTo(
                    "/b/jwUipscNvd/find-token?campaignId=rNFOhz1pUS&objectDefinitionId=Bl50jKxgg0&autoClaim=true&sync=true"),
                _showActionSheet(context)
              },
              child: const Text('error jwUipscNvd'),
            ),
            // ElevatedButton(
            //   onPressed: () => {
            //     wallet.linkTo(
